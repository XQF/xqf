...
extern struct server *server_add (struct host *h, unsigned short port, enum server_type type);
extern struct userver *userver_add (const char *name, unsigned short port, enum server_type type);
...
extern GSList *server_list_append_list (GSList *list, GSList *servers, enum server_type type);
extern GSList *userver_list_append_list (GSList *list, GSList *uservers, enum server_type type);
